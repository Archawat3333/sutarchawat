...
function CourseInfo() {
    const [course, setCourse] = React.useState<CoursesInterface>();
            ...
            <Grid
                ...
                <Stack
                    ...
                    <Stack className="Information"
                        ...
                        <Typography variant="h5" sx={{ width: "auto" }}> {course?.Course_ID}</Typography>
                        <Typography variant="h5" sx={{ width: "auto" }}> {course?.Course_Name}</Typography>
